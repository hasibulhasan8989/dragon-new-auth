    ...
    <div className="bg-[#F3F3F3] py-4 px-4 flex items-center mt-8
     ">
      ...
      <Marquee speed={80} pauseOnClick={true} style={{cursor:'pointer', color:'#FE5D26',opacity:1,}}>
        ...
        <p class="mr-12"> চমকপ্রদ: ইন্টারনেট গেলো অফলাইনে, সবাই এখন লাইভ!</p>
        <p class="mr-12"> দুঃসংবাদ নয় – আজও বৃষ্টির নামে ধোঁকা দিলো আকাশ!</p>
        <p class="mr-12"> নাচতে না জানলে দোষ বাইরের গানের: বলল এক বিড়াল!</p>
        <p class="mr-12"> অবাক কাণ্ড: আলু বলেছে “আমি ভাতের রাজা হতে চাই!”</p>
        <p class="mr-12">
        ...
        <p class="mr-12"> বিয়ে না করেই শশুরবাড়ি গেছে বর! মামলা ভাবীর!</p>
      </Marquee>
    </div>
  );
};
